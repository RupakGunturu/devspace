...
export default function WorldClock() {
  ...
  const update = () => {
    ...
    for (const z of zones) {
      try {
        result[z] = new Date().toLocaleString("en-US", {
          timeZone: z,
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
    ...
    <ToolLayout id="world-clock">
      <div className="flex flex-col sm:flex-row gap-2">
        <input
          ...
          className="flex-1 p-2.5 bg-paper-dim/50 border border-border rounded-sm text-sm font-mono text-foreground"
        />
