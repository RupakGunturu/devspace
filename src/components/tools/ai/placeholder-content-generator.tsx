...
export default function PlaceholderContentGenerator() {
  ...
  const data: Record<string, string[]> = {
    ...
    address: [
      ...
      "456 Oak Ave, LA",
      "789 Pine Rd, Chicago",
      "321 Elm Blvd, Houston",
      "654 Maple Dr, Phoenix",
      "987 Cedar Ln, Seattle",
      "147 Birch Way, Denver",
      "258 Walnut Ct, Boston",
      "369 Spruce Pl, Austin",
      "741 Ash Ter, Portland",
    ],
    company: [
      "TechCorp",
      "InnovateCo",
      ...
      <div className="flex items-center gap-4">
        <div>
          ...
          <input
            ...
            className="w-20 p-2.5 bg-paper-dim/50 border border-border rounded-sm text-sm font-mono text-foreground"
          />
        </div>
