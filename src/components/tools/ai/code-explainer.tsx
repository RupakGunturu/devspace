  ...
  const explain = () => {
    ...
    const result = lines.map((line, i) => {
      ...
      if (trimmed.startsWith("import "))
        explanation = "Import statement — brings in external module";
      else if (trimmed.startsWith("export "))
        explanation = "Export — makes this available to other modules";
        ...
        explanation = "Conditional — runs block if condition is true";
        ...
        explanation = "Class definition — blueprint for objects";
