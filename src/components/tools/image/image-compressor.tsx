    ...
    <ToolLayout id="image-compressor">
      ...
      {original && compressed && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-3 bg-paper-dim/50 border border-border rounded-sm text-center">
            <span className="text-[10px] uppercase tracking-wider text-muted-foreground">
              Original
            </span>
            <p className="font-mono text-lg font-bold text-foreground">
              {(original.size / 1024).toFixed(1)}KB
            </p>
          </div>
          <div className="p-3 bg-paper-dim/50 border border-border rounded-sm text-center">
            <span className="text-[10px] uppercase tracking-wider text-muted-foreground">
      ...
      {compressed && (
        <a
          href={compressed.url}
          download
          className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-opacity hover:opacity-90"
