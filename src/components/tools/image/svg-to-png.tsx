...
export default function SvgToPng() {
  ...
  return (
    <ToolLayout id="svg-to-png">
      ...
      {url && <div className="flex flex-col items-center gap-4"><img src={url} alt="PNG" className="border border-border rounded" /><a href={url} download="converted.png" className="text-sm hover:underline" style={{ color }}>Download PNG</a></div>}
    </ToolLayout>
  );
}
