    ...
    <ToolLayout id="font-weight-gallery">
      <div className="flex gap-2 items-center">
        <input
          ...
          className="flex-1 p-2.5 bg-paper-dim/50 border border-border rounded-sm text-sm text-foreground"
      ...
      <div className="space-y-2">
        {weights.map((w) => (
          <div key={w} className="p-3 bg-paper-dim/50 border border-border rounded-sm">
            <p style={{ fontFamily: font, fontWeight: w }} className="text-xl text-foreground">
