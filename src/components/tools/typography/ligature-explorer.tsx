    ...
    <ToolLayout id="ligature-explorer">
      <div className="space-y-3">
        <div className="p-4 bg-paper-dim/50 border border-border rounded-sm">
          <p className="text-2xl text-foreground" style={{ fontVariantLigatures: "common" }}>
            {text}
          </p>
          <p className="text-[10px] text-muted-foreground mt-1">Ligatures: ON</p>
        </div>
        <div className="p-4 bg-paper-dim/50 border border-border rounded-sm">
          <p className="text-2xl text-foreground" style={{ fontVariantLigatures: "no-common" }}>
            {text}
          </p>
      ...
      <div className="space-y-1.5">
        {ligatures.map((l) => (
          <div
            key={l.name}
            className="flex items-center justify-between p-2.5 bg-paper-dim/50 border border-border rounded-sm"
          >
