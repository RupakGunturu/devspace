      ...
      <div className="flex flex-col sm:flex-row sm:items-end gap-3">
        <div className="flex-1">
          ...
          <input
            ...
            className="w-full p-2 bg-paper-dim/50 border border-border rounded text-sm font-mono text-foreground text-center"
            maxLength={2}
          />
        </div>
        <div className="flex-1">
        ...
        <ToolButton onClick={generate} className="w-full sm:w-auto">
          Generate
        </ToolButton>
      </div>
      {url && (
        <div className="flex flex-col items-center gap-4">
          <img src={url} alt="Favicon" className="w-16 h-16 border border-border rounded" />
          <a
            href={url}
