  ...
  return (
    <ToolLayout id="env-var-generator">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">DB Host</label>
          <input
            value={dbHost}
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">DB Port</label>
          <input
            value={dbPort}
      ...
      <ToolInput
        ...
        label="Extra Variables (one per line)"
        rows={3}
      />
