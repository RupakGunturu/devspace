...
export default function DockerCommandBuilder() {
  ...
  return (
    <ToolLayout id="docker-command-builder">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            className="w-full p-2 bg-background border border-border rounded text-xs font-mono"
          />
        </div>
        <div>
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">Volume (host:container)</label>
          <input
            value={volume}
      ...
      <div>
        <label className="text-[10px] text-muted-foreground">Env vars (comma separated)</label>
        <input
          value={env}
