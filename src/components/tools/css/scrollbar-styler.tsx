  ...
  return (
    <ToolLayout id="scrollbar-styler">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">Radius: {radius}px</label>
          <input
            type="range"
            min="0"
            max="10"
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">Thumb Color</label>
          <input
            type="color"
            value={thumbColor}
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">Track Color</label>
          <input
            type="color"
            value={trackColor}
