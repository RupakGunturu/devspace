  ...
  return (
    <ToolLayout id="css-outline-border-explorer">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="text-[10px] text-muted-foreground">Width: {width}px</label>
          <input
            type="range"
            min="1"
            max="10"
        ...
        <div>
          <label className="text-[10px] text-muted-foreground">Offset: {offset}px</label>
          <input
            type="range"
            min="-10"
            max="10"
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2 bg-paper-dim/50 border border-border rounded text-xs text-foreground"
          >
            {styles.map((s) => (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="p-4 bg-paper-dim/50 border border-border rounded-sm text-center">
          <span className="text-xs text-muted-foreground mb-2 block">Border</span>
          <div
            className="w-20 h-20 mx-auto bg-yellow/10"
