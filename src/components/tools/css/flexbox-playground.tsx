...
export default function FlexboxPlayground() {
  ...
  return (
    <ToolLayout id="flexbox-playground">
      ...
      <div>
        <label className="text-[10px] text-muted-foreground">Gap: {gap}px</label>
        <input
          type="range"
          min="0"
          max="32"
      ...
      <div
        className="p-4 bg-paper-dim/50 border border-border rounded-sm"
        style={{
          display: "flex",
      ...
      >
        {[40, 60, 48, 56, 44, 52].map((h, i) => (
          <div key={i} className="w-12 rounded bg-yellow" style={{ height: `${h}px` }} />
        ))}
      </div>
