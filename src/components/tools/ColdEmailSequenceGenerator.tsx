    ...
    <ToolLayout id="cold-email-sequence-generator">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <ToolInput
          value={product}
          onChange={setProduct}
          placeholder="e.g. DevSpace, a developer productivity tool"
        ...
        <ToolInput
          ...
          placeholder="e.g. SaaS startup CTOs"
      ...
      <ToolInput
        ...
        placeholder="e.g. automate repetitive tasks and ship features 3x faster"
      ...
      <ToolInput
        value={cta}
        onChange={setCta}
        placeholder="e.g. Book a demo at devspace.io/demo"
      ...
      <div className="flex flex-wrap gap-2">
        <ToolButton
          onClick={generate}
          disabled={!product.trim() || !audience.trim() || !valueProp.trim() || !cta.trim()}
        >
          Generate Sequence
        </ToolButton>
            ...
            return (
              <div key={i} className="rounded-lg border-2 border-line bg-input-bg p-4 space-y-3">
                ...
                <div>
                  ...
                  <pre className="mt-0.5 whitespace-pre-wrap break-all font-mono text-xs text-input-text">
                    {email.body}
                  </pre>
                </div>
              </div>
