...
export default function WcagContrastChecker() {
  ...
  return (
    <ToolLayout id="wcag-contrast-checker">
        ...
        <div>
          ...
          <div className="flex gap-2 items-center">
            <input
              ...
              className="w-10 h-8 bg-background border border-border rounded cursor-pointer"
            />
      ...
      <div className="p-4 rounded-sm text-center" style={{ backgroundColor: bg, color: fg }}>
