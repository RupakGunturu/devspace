...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "What DevSpace is, who it's for, and why a student built it." },
      { property: "og:title", content: "About DevSpace" },
      { property: "og:description", content: "A student-built weekly dev zine with tools and games." },
    ],
  }),
  component: About,
});
    ...
    <section className="mx-auto max-w-2xl px-6 py-16 sm:px-8 sm:py-24">
      ...
      <div className="mt-10 space-y-5 text-lg text-muted">
        ...
        <p>
          ...
          across a handful of{" "}
          <Link to="/feed/$series" params={{ series: "bug-of-the-week" }} className="text-yellow no-underline">
            recurring series
          </Link>
          .
        </p>
